...
CREATE TABLE `department` (
  ...
  KEY `Dep_emp` (`Mgr_ssn`),
  CONSTRAINT `Dep_emp` FOREIGN KEY (`Mgr_ssn`) REFERENCES `employee` (`Ssn`),
...
INSERT INTO `department` VALUES ('Headquarters',1,'888665555','1981-06-19'),('Administration',4,'987654321','1995-01-01'),('Research',5,'333445555','1988-05-22'),('Data science',7,'333445555',NULL);
...
CREATE TABLE `employee` (
  ...
  CONSTRAINT `Emp_dno` FOREIGN KEY (`Dno`) REFERENCES `department` (`Dnumber`),
  CONSTRAINT `Emp_emp` FOREIGN KEY (`Super_ssn`) REFERENCES `employee` (`Ssn`),
  CONSTRAINT `Emp_super` FOREIGN KEY (`Super_ssn`) REFERENCES `employee` (`Ssn`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-08 18:54:48
